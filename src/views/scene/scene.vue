      ...
      <div class="devopsBigScreen">
        <div :style="bigScreenStyle">
          ...
          <div class="text text1">
            数据预处理：历史数据<span class="big_text">可信度</span>提升至<span class="big_text">99.87%</span>
          </div>
          <div class="text text2">
            典型因子研究：气象要素、设备参数、典型地貌等<span class="big_text">14个</span>影响因子
          </div>
          <div class="text text3">
            数据网格化：降尺度模型获取<span class="big_text">3*3Km</span>网格化气象预报数据
          </div>
          <div class="text text4">
            区域建模：构建基于不同时空特征的模型<span class="big_text">9个</span>
          </div>
          <div class="text text5">
            模型融合：短时<span class="big_text">（0-4h）</span>、超短时<span class="big_text">（0-72h）</span>模型<span class="big_text">自适应融合修正</span>
          </div>
          <!-- 右下文本 -->
        ...
        textList: [
          {
            text: '模型融合',
            fontSize: 50,
            fontFamily: 'DOUYINSANSBOLD, DOUYINSANSBOLD',
            fontWeight: 'normal',
            textAlign: 'left',
            color: '#BCE3FF',
            width: 200,
